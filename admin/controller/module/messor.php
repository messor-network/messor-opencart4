...
namespace Opencart\Admin\Controller\Extension\Messor\Module; //todo add namespace
...
class Messor extends \Opencart\System\Engine\Controller //todo change name class and change extends
{
    use Opencart;
